...
# ---------------- ADDONS (OPTIONAL) ----------------
# Addons are isolated under /addons/* and must not change existing UI/templates.
ADDONS_PLATFORM_ENABLED = os.getenv("ADDONS_PLATFORM_ENABLED", "False").lower() == "true"

if ADDONS_PLATFORM_ENABLED:
    INSTALLED_APPS += [
        "addons.hotfixes",
        ...
        "addons.ads_manager",
        "addons.ecommerce_engine",
        "addons.courier_integration",
        "addons.transport_management",
        "addons.warehouse_plus",
        "addons.hr_autopilot",
        "addons.accounting_upgrade",
        "addons.banking_automation",
        "addons.analytics_ai",
    ]
...
MIDDLEWARE = [
    ...
    # Route /addons/* to isolated addons urlconf (no changes to existing urls/templates).
    "addons.middleware.AddonsURLRoutingMiddleware",
]
